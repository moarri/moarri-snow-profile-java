...
abstract class TempOrNilReasonType extends NilReasonType {
    public static final double MIN_INCLUSIVE_VALUE = -110.0;
    public static final double MAX_INCLUSIVE_VALUE = 60.0;
    ...
    TempOrNilReasonType(NilReasonEnumeration nilReason) {
        super(nilReason);
    }

    TempOrNilReasonType(double value) throws ValueOutsideRangeException {
        super(null);
